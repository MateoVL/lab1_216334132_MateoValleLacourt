...
;RF2: player
(define p-1 (player 1 "Toto" "rojo" 0 0 0 21))
(define p-2 (player 2 "Cristobal" "negro" 0 0 0 21))
(define p-3 (player 3 "Mateo" "blanco" 0 0 0 21))
(define p-4 (player 4 "PapaFrita" "amarillo" 0 0 0 21))
(display "\nRF2: player\n")
p-1
p-2
p-3
...
;RF3: piece
(define pieza-blanca (piece "blanco"))
(define pieza-negra (piece "negro"))
...
(define b1 (board-set-play-piece b0 6 pieza-blanca))
(define b2 (board-set-play-piece b1 6 pieza-negra))
...
(define updated-game (game p-1 p-4 tablero-1 2))
